...
M=2;
 ...
 ylabel( 'Control cost','FontName','Times New Roman','FontWeight','bold');
  set(gca,'FontName','Times New Roman','FontWeight','bold')
    ...
    export_fig cost1_alpha_05.eps -painters -transparent
 ...
 ylabel('Control cost','FontName','Times New Roman','FontWeight','bold');
  set(gca,'FontName','Times New Roman','FontWeight','bold')
    export_fig cost2_alpha_05.eps -painters -transparent
% % eval(subs(x,'t',tf))
% xxx=[];
...
set(ez1(ii), 'LineWidth', 1.5,'LineStyle','--');
 ...
 ylabel('The state of x ','FontName','Times New Roman','FontWeight','bold');
  set(gca, 'LineWidth', 1.5);
  set(gca,'FontName','Times New Roman','FontWeight','bold')
 export_fig x_alpha_05.eps -painters -transparent
...
set(ez1(ii), 'LineWidth', 1.5,'LineStyle','--');
 ...
 export_fig u_alpha_05.eps -painters -transparent